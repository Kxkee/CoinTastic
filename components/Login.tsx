...
export default function Login({setIsToggle}: props) {
    ...
    return (
        <>
            ...
            <button className="w-full flex items-center justify-center gap-x-3 py-3 border rounded-lg text-sm font-medium hover:bg-gray-800 duration-150 active:bg-gray-100 text-gray-50">
